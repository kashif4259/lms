            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header p-2">
                        ...
                        <li class="nav-item" style="display:none"><a class="nav-link" href="#activity" data-toggle="tab">Activity</a></li>
                            ...
                            <div class="tab-pane active show" id="settings">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea  v-model="form.bio" class="form-control" id="inputExperience" placeholder="Experience" :class="{ 'is-invalid': form.errors.has('bio') }"></textarea>
                                     ...
                                     <div class="invalid-feedback" v-if="form.errors.has('bio')">
                                        {{form.errors.get('bio')}}
                                    </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="file" @change="uploadProfilePicture"  name="photo" class="form-input">
                                    </div>
                                </div>
    ...
    export default {
        ...
        methods: {
            ...
            updateProfile() {
                ...
                this.form.put('users/profile/'+this.form.id)
                .then((response) => {
